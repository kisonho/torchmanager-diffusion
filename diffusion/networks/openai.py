...
class ConditionalUNet(th.nn.Module):
    ...
    def convert_to_fp16(self):
        """
        Convert the UNet torso to float16 while keeping numerically sensitive
        layers such as timestep embeddings and the output head in float32.
        """
    ...
    def convert_to_fp32(self):
        """
        Convert the UNet torso back to float32.
        """
    ...
    def forward(self, x, timesteps: int | None = None, context: th.Tensor | None = None, y: th.Tensor | None = None) -> th.Tensor:
        """
